...
$(document).ready(function () {
    ...
    // @todo ver como integrar este metodo, verificar que se muestre el saldo en los campos de montos de forma de pago
    // Evento para calcular el saldo en los montos de los modals
    ...
    //
    //         var saldo = parseFloat(total) - parseFloat(efectivo);
    //         $('#monto_cuenta_credito').val(saldo)
    //         $('#monto_cheque').val(saldo)
    //         $('#monto_deposito').val(saldo)
    //         $('#monto_tarjeta').val(saldo);
    //     // }
    // });
    ...
    /*------------------------------
     ...
     ------------------------------*/
    // @todo si se va a integrar el calculador de cambio descomentar este codigo y el de la vista
