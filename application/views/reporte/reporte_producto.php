        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-files-o fa-2x"></i> <b>REPORTE DE STOCK DE INVENTARIO</b>
                    </h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-1" style="width: 8%">
                                            <button class="btn btn-danger btn-sm" onclick="buscar_inventario();"
                                                    title="Busqueda de los datos"><i
                                                        class="fa fa-search"></i> Buscar
                                            </button>
                                        </div>
                                        <div class="col-md-1" style="width:12%;">
                                            <a class="btn btn-success btn-sm" onclick="exportar_excel_inventario()"
                                               title="Exportacion a archivo excel">
                                                <i class="fa fa-file-excel-o"></i> Exportar excel
                                            </a class="btn">
                                        </div>
                                        <div class="col-md-1">
                                            <a class="btn btn-warning btn-sm" onclick="imprimir_inventario1()"
                                               href="" target="_blank"
