                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1" style="padding: 1%">
                                    ...
                                    <form class="form-horizontal">
                                        <div class="col-lg-8 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <label class="control-label col-lg-4 col-md-4" for="fecha-inicio">Fecha
                                                    inicio:</label>
                                                <div class="col-lg-8 col-md-8">
                                                    <input type="date" class="form-control" id="fecha-inicio"
                                                           name="fecha-inicio" value="<?= $fecha_inicio ?>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-lg-4 col-md-4" for="fecha-fin">Fecha
                                                    fin:</label>
                                                <div class="col-lg-8 col-md-8">
                                                    <input type="date" class="form-control" id="fecha-fin"
                                                           name="fecha-fin" value="<?= $fecha_actual ?>">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <h3 class="page-header " style="margin-top: 5px"><strong>Flujo caja:
                                            &nbsp;&nbsp;</strong><label for="" id="label-flujo"> </label></h3>
                                </div>
                            </div>
                            <!-- /.tab-pane -->
