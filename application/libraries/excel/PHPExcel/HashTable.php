...
class PHPExcel_HashTable
{
	...
	/**
	 * Add HashTable producto
	 *
	 * @param	PHPExcel_IComparable $pSource	Producto to add
	 * @throws	PHPExcel_Exception
	 */
	...
	/**
	 * Remove HashTable producto
	 *
	 * @param	PHPExcel_IComparable $pSource	Producto to remove
	 * @throws	PHPExcel_Exception
	 */
