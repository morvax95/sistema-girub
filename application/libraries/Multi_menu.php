...
class Multi_menu {
	...
	/**
	 * Tag opening tag of the menu producto
	 * default is '</li>'
	 * 
	 * @var string
	 */
	...
	/**
	 * Closing tag of the menu producto
	 * default is '</li>'
	 * 
	 * @var string
	 */
	...
	/**
	 * Opening tag of the menu producto that has children
	 * default is '</li>'
	 * 
	 * @var string
	 */
	...
	/**
	 * Closing tag of the menu producto that has children
	 * default is '</li>'
	 * 
	 * @var string
	 */
	...
	/**
	 * Anchor tag of the menu producto that has children
	...
	/**
	 * Opening tag of the menu producto level one that has children
	...
	/**
	 * Closing tag of the menu producto level one that has children
	...
	/**
	 * Anchor tag of the menu producto level one that has children
	...
	/**
	 * The producto that has active class.
	...
	/**
	 * Anchor tag of the menu producto.
	 * Default is '<a href="%s">%s</a>'
	 * 
	 * @var string
	 */
     ...
     *                                  		It also possible to define active producto of the menu here with string value.
     * @param  array 	$divided_items_list 	menu items that would be divided   
     * @param  string 	$divider 				divider producto
     * @return string               
     */
    ...
    /**
     * Prepare producto before render
     * 
	...
	{	    
	    if ( empty($html) ) 
	    {
			...
			// check is there additiona menu producto for the the first place
	    ...
	    foreach ($items as $item)
	    {
	        ...
	        if ( isset($item[$this->menu_label], $item[$this->menu_key]) ) 
	        {
		        ...
		        // if menu producto need separator
	...
	/**
	 * Inject producto to menu
	 * Call this method before render method call
	 * 
	 * @param  string $item     menu producto that would be injected
	 * @param  string $position position where the additiona menu producto would be placed (fist or last)
	 * @return Multi_menu           
	 */
